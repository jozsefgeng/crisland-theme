	...
	<div class="max-w-screen-xl m-auto px-3.5 md:px-5 2xl:max-w-screen-2xl py-12">
		<div class="md:grid md:grid-cols-4 md:gap-x-10 lg:px-0">
			...
			<div class="mb-8">
				<div class="grid">
					<div class="mb-5">
						<p class="mb-3 md:mb-1.5 text-base uppercase">
							<?php echo __('Servicii'); ?>
						</p>
						<ul class="list-none text-base pl-0">
							<?php foreach ($navigation as $item) : ?>
							<li class="mb-3 md:mb-1.5">
								<a href="<?php echo esc_url($item['url']); ?>"
									class="no-underline"><?php echo esc_html($item['title']); ?></a>
							</li>
							<?php endforeach; ?>
						</ul>
					</div>
					...
					<ul class="flex flex-wrap list-none pl-0">
						<li class="flex items-center">
							<span class="block mb-0 w-20">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icon/dpd.png"
									class="w-20">
							</span>
						</li>
						<li>
							<span class="block mb-0 w-20">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icon/sameday.png"
									class="w-20">
							</span>
						</li>
					</ul>
			...
			<div class="footer-legal ml-auto">
				<ul class="mb-0 list-none">
					<li class="inline-block mr-4">
						<a href="<?php echo get_permalink(get_page_by_path('termeni-si-conditii')); ?>"
							class="no-underline text-white"><?php echo __('Termeni și condiții'); ?></a>
					</li>
					<li class="inline-block mr-4">
						<a href="<?php echo get_permalink(get_page_by_path('politica-de-confidentialitate')); ?>"
							class="no-underline text-white"><?php echo __('Politica de confidențialitate'); ?></a>
					</li>
					<li class="inline-block mr-4">
						<a href="<?php echo get_permalink(get_page_by_path('politica-de-cookies')); ?>"
							class="no-underline text-white"><?php echo __('Politica de cookies'); ?></a>
					</li>
					<li class="inline-block mr-4">
						<a href="https://anpc.ro/" target="_blank" rel="noopener noreferrer"
							class="no-underline text-white"><?php echo __('Anpc'); ?></a>
					</li>
				</ul>
			</div>
		</div>
